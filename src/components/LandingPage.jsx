          ...
          <div className="flex gap-12 flex-col items-center text-center">
            ...
            <div className="flex gap-80 justify-center items-center">
              <div
                ...
                className="w-[400px] h-[400px] justify-center flex flex-col gap-4 items-center rounded-2xl bg-[#fcf9f8] cursor-pointer hover:scale-[105%] transition-all duration-300"
              >
                <lord-icon
